...
const ReviewSummary: React.FC<Props> = ({
  ...
  return (
    <div className="review-summary" ng-class="{'common-combine-box': allowCustomerFlg || vm.reqType != 'PA' || !vm.loginStatus,'common-financial-box': !allowCustomerFlg && vm.reqType == 'PA' && vm.loginStatus, 'default': true}">
        ...
        <form className="content-form" name="moreAboutYouForm" noValidate>
          <div className="summary-more-content common-sub-box">
            ...
            <select-edit-review
              ...
              drop-down-list={vm.allNationality}
              current-form="moreAboutYouForm"
              field-name="'nationality'"
              select-mode="'REVIEW'"
              drop-down-key={['option', 'value']}
              ng-if="profile.identity != 1 && reqType !== 'PER' && reqType !== 'PC' && reqType !== 'PAT' && !myInfoSelected"
            ></select-edit-review>
            {/* Residency Status and Pass type if foreigner */}
            <div ng-if="reqType === 'PER' || reqType === 'PC' || reqType === 'PAT'" className="each-group residency-section">
              ...
              <div ng-if="moreAboutYouDetails.residencyCode == 3">
            ...
            <div className="each-group">
              ...
              <div className="each-group">
                <questions-pru
                  ...
                  questionnaire-json={vm.allQuestionaire}
                  check-if-kickout={vm.checkIfKickout(qCode)}
                  questionnaire-cat={vm.questionCat}
