      ...
      <div className="about-you common-job-box review-summary">
        <div className="common-box-content">
          <div className="section-title">
            Personal details
            {summaryStep === 'REVIEW' && (
              <a className="pull-right edit-section-link" onClick={() => {}}>
                EDIT
              </a>
            )}
          </div>
          <div className="common-sub-box">
            <form className="content-form" name="aboutYouForm" noValidate>
              ...
              {!firstName && loginStatus && (
                <div className="row each-group">
                  <div className="col-xs-12 col-sm-6 form-group">
                    <input-review
                      about-you-form="aboutYouForm"
                      input-value={lastName}
                      input-details={vm.inputDetails[0]}
                      login-status={loginStatus}
                      validate-input={(type, str) => {}}
                    ></input-review>
                ...
                <div className="row each-group">
                  <div className="col-xs-12 col-sm-6 form-group">
                    <input-review
                      ...
                      input-details={vm.inputDetails[1]}
                      login-status={loginStatus}
                      validate-input={(type, str) => {}}
                    ></input-review>
                    <span className="field-support">Per your NRIC</span>
              ...
              <div className="row each-group">
                <div className="col-xs-12 col-sm-6 form-group">
                  <label className="static-label label-grey" htmlFor="nric">
                    NRIC/FIN/Identification No.
                  </label>
                ...
                <div className="col-xs-12 col-sm-6 form-group" style={{ display: isExistCustomerDecl === 'false' || myInfoSelected ? 'block' : 'none' }}>
                  <div>
                    <phone-input
                      ...
                      idd={idd}
                      number={number}
                      mobile-valid-error={mobileValidError}
                      idd-valid-error={IDD}
                      login-status={loginStatus}
                      validate-input={(type, str, prerequisite) => {}}
                    ></phone-input>
                  </div>
                  <div>
              ...
              <div className="row each-group">
                ...
                <div className="col-xs-12 col-sm-6 form-group">
                  ...
                  <span className="field-support" style={{ display: !loginStatus && isPAS ? 'block' : 'none' }}>
                    Editing your DOB might require you to restart your application
                  </span>
                </div>
              </div>
              ...
              <div className="row each-group">
                <div className="col-xs-12 col-sm-6 form-group">
                  <input-review
                    about-you-form="aboutYouForm"
                    input-value={email}
                    input-details={vm.inputDetails[3]}
                    validate-input={(type, str) => {}}
                  ></input-review>
                </div>
                <div className="col-xs-12 col-sm-6 form-group">
                  <questions-pru
                    ng-if={aboutYouQuestions.length > 0}
                    filter-question={aboutYouQuestions}
                    questionnaire-json={aboutYouQ}
                    questionnaire-cat={questionnaireCat}
                    edit-mode={summaryStep !== 'REVIEW'}
                  ></questions-pru>
                </div>
              </div>
              {showMediSave && (
                <div className="row each-group">
                  <div className="col-xs-12 form-group">
                    <label className="static-label label-grey" htmlFor="mediSave">
                      MediSave Account
                    </label>
                    <p className="view-form-input">{nric}</p>
                  </div>
