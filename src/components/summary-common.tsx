...
const Summary: React.FC<Props> = ({
  ...
  const updateValidResult = (event: any) => {
    // Handle validation result update
  };
  ...
  const triggerDeclaration = () => {
    // Handle trigger declaration
  };

  const proxyOnClick = () => {
    // Handle proxy on click
  };
    ...
    <div className="summary-container">
      <div className="summary-header">
        <div className="header-title">
          <div className="container visible-lg header-title-normal">{pageTitle}</div>
          <div className="container hidden-lg header-title-normal-mobile">{pageTitle}</div>
        </div>
        {showError && (
      ...
      <div className="summary-navbar" style={{ display: profile.type === 'PL' || profile.type === 'PM' ? 'block' : 'none' }}>
            ...
            <div className="col-md-12 content-title-box">
              {summaryStep === 'EDIT' ? (
                ...
                <>
                  ...
                  {summaryStep !== 'EDIT' && (
                    <div className="content-view-message" style={{ display: showSaveMessage ? 'block' : 'none' }}>
                ...
                <div className={`common-box-header ${isCollapsed ? 'isCollapse' : ''}`}>
                  <div className="row">
                    ...
                    <div className="col-xs-2">
                      <a className={isCollapsed ? 'isCollapse' : ''} href="#" onClick={() => setIsCollapsed(!isCollapsed)}>
