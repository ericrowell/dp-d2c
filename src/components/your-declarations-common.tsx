      ...
      <section id="your-declarations">
        ...
        <div className="common-box-content">
          ...
          <div className="consent-box">
            ...
            <div>
              <button className="button-accept-desktop" onClick={() => closeDialog(1)}>ACCEPT</button>
            </div>
          </div>
          <div className="mask-box"></div>
          <div className="scroll-msg-box">
            <a href="javascript:;" className="desktop-scroll-msg">Scroll to read on</a>
            <a href="javascript:;" id="mobile-scroll-msg" className="mobile-scroll-msg" onClick={() => setStatus(0)}>{scrollMsg}</a>
          </div>
        </div>
      </section>
      ...
      {status === 0 && (
        <section id="continue-footer">
          <div className="continue-box">
            <button className="button-continue-mobile" onClick={() => setStatus(1)}>CONTINUE</button>
          </div>
        </section>
      )}
      ...
      {status === 1 && (
        <section id="consent-footer">
          <div className="consent-box-mobile">
            ...
            <div>
              <button className="button-accept-mobile" onClick={() => closeDialog(1)}>ACCEPT</button>
            </div>
          </div>
        </section>
      )}
